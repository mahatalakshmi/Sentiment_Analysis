...
def predict():
    ...
    po,ne,nu=get_titles(input_value)

    if po>ne and po>nu:
        return render_template('index.html',pred='The given topic have more positive opinions of about {}'.format(po),bhai="kuch karna hain iska ab?")
    elif ne>po and ne>nu:
        return render_template('index.html',pred='The given topic have more negative opinions of about {}'.format(ne),bhai="kuch karna hain iska ab?")
    else:
        return render_template('index.html',pred='The given topic have more neutral opinions of about {}'.format(nu),bhai="Your Forest is Safe for now")
