    ...
    <div class="container">
        ...
        if (isset($_POST["submit"])) {
           ...
           if (count($errors)>0) {
            ...
            $sql = "INSERT INTO login_details (firstname,lastname, email, password,confirmpassword) VALUES ( ?, ?, ?,?,? )";
            $stmt = mysqli_stmt_init($conn);
            $prepareStmt = mysqli_stmt_prepare($stmt,$sql);
            if ($prepareStmt) {
                mysqli_stmt_bind_param($stmt,"sssss",$firstName,$lastName, $email, $passwordHash,$passwordRepeat);
